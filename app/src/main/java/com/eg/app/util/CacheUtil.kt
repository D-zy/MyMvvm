...
//    }
    ...
    var token: String
        get() = MmkvUtil.decodeString("token", "")
        set(value) = MmkvUtil.encode("token", value)

    var isFirst: Boolean
        get() = MmkvUtil.decodeBoolean("isFirst", true)
        set(value) = MmkvUtil.encode("isFirst", value)

    var isLogin: Boolean
        get() = MmkvUtil.decodeBoolean("isLogin", false)
        set(value) = MmkvUtil.encode("isLogin", value)
