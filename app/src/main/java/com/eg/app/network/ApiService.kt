...
interface ApiService {
    ...
    companion object {
        ...
        const val SERVER_URL = "https://test-overseas.91dbq.com/boss-gateway-sg/"
        const val SERVER_URL1 = "https://rel-overseas.91dbq.com/boss-gateway-sg/"
    }
...
//     */
    ...
    @POST("boss/login")
    suspend fun login(
            @Header("Time-Stamps") time: String,
