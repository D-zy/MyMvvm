...
public class SimpleViewBehavior extends PercentageViewBehavior<View> {
    ...
    public SimpleViewBehavior(Context context, AttributeSet attrs) {
        ...
        targetScale = a.getFloat(R.styleable.ViewBehavior_behavior_targetScale, UNSPECIFIED_FLOAT);
    ...
    void prepare(CoordinatorLayout parent, View child, View dependency) {
        ...
        mStartScaleX = child.getScaleX();
        mStartScaleY = child.getScaleY();
    ...
    void updateViewWithPercent(View child, float percent) {
        ...
        // set scale
        if (targetScale != UNSPECIFIED_FLOAT) {
            child.setScaleX(mStartScaleX + (targetScale - mStartScaleX) * percent);
            child.setScaleY(mStartScaleY + (targetScale - mStartScaleY) * percent);
        }
